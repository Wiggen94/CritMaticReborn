...
Critmatic.showChangeLog = function()
    ...
    frame:SetTitle("CritMatic Reborn - Changelog")
    frame:SetStatusText("Thank you for using CritMatic Reborn!")
...
[v0.5.0.0] - Initial Release of CritMatic Reborn
...
Improvements:
- Completely redesigned Settings Panel with 6 logical tabs:
  General, Alerts, Sounds, Sharing, Ignored, Advanced
- Crit Log window is now resizable - Drag the corner to resize, content scales with window size
...
Bug Fixes:
- Fixed wrong spell icons in crit log - Icons are now stored at record time instead of looked up later
